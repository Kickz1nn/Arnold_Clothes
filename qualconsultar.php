...
?>
        <form name="produto" action="consultado.php" method="post">
        <div class="form-row">
                    <div class="form-group col-md-6" style="margin-top: 30px; margin-left: 30px; margin-bottom:10px;">
                        <label for="tamanho">id</label>
                        <input type="number" class="form-control" name="tamanho" id="tamanho" placeholder="" required>
                    </div>
                
                </div>
                <button type="submit" class="btn btn-secondary" id="enviar" style="margin-left: 30px;" >Adicionar</button>
        </form>
    </body>
