...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="m-4">
            <h3>Confirmação da alteração</h3>
           	<?php
               ...
               $sqlupdate = "update roupas set quantidade=$quantidade, descricao='$descricao', precou =$precou, img = '$img', tamanho =$tamanho where id = $id ";
               ...
               ?>
            <br><br>
            <input type='button' onclick="window.location='qualedt.php';" value="Voltar">
                </div>
    </body>
